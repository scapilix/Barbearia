            ...
            <motion.div initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} exit={{ opacity: 0, scale: 0.95 }} className="modal-content w-full max-w-lg mx-4" onClick={e => e.stopPropagation()}>
              <form onSubmit={handleSave}>
                ...
                <div className="p-6 space-y-4">
                  ...
                  <div><label className="text-sm font-medium text-dark mb-1.5 block">Função</label><input value={formData.role} onChange={e => setFormData({ ...formData, role: e.target.value })} className="luxury-input" placeholder="Ex: Barber Designer, Esteticista..." /></div>
